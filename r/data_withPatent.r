skills <- tribble(
  ...
  "Proteomics", "In gel and solution trypsin digestion, immunodepletion of serum samples, label free quantification, isobaric labeling, off-line SCX fractionation, SRM mass spectrometry, PTMs profiling andaffinity chromatography",
  "Mass spectrometry", "Operation and troubleshooting of a range of instruments LTQ Orbitrap Velos Pro, Q Exactive series, TSQ Vantage (all from Thermo Scientific), MALDI-TOF-MS (Applied Biosystem), SYNAPT HDMS (Waters), API QSTAR Pulsar (AB SCIEX)",
...
work <- tribble(
  ...
  "Postdoctoral Researcher", "Department of Biochemistry and Molecular Biology, University of Southern Denmark", "January", 2020, "Present", NA, "Odense - Denmark", "Development of a post-translational modification specific biomarker discovery platform",
